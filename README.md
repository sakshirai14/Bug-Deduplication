...
This system helps QA and engineering teams reduce redundant issue tracking, improve triaging efficiency, and accelerate resolution time.

---

## 🚀 Problem Statement

In large-scale software projects, multiple users often report the same issue in slightly different ways.

Manually identifying duplicate bug reports:
